...
const capitulo = [
  ...
  },
  {
    ...
    texto:
      "Nossa equipe caminha do começo ao fim. Você escreve; a gente cuida do resto.",
  },
  {
    kicker: "Sem pressa",
    titulo: "No seu tempo",
...
const comoFunciona = [
  ...
  },
  {
    ...
    texto:
      "Um editor entra em contato, sem compromisso, para colocar o papo em dia.",
  },
  {
    numero: "03",
    titulo: "Você escreve",
    texto:
      "Quando aparecer o projeto certo, com nosso acompanhamento do início ao fim.",
  },
];
    ...
    <main className="overflow-x-hidden bg-background text-foreground">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          <div>
            ...
            <AnimateOnView delay={0.2}>
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
                Você já publicou com a gente, e isso deixou marca. Queríamos
                retomar o contato e conversar sobre publicar de novo, quando
          ...
          <AnimateOnView delay={0.25} className="relative">
            ...
            <p className="mt-6 max-w-sm text-base leading-relaxed text-muted-foreground">
              Seu livro segue nas nossas estantes. E o seu jeito de escrever
              continua bem-vindo aqui.
            </p>
          </AnimateOnView>
        </div>
      </section>
      ...
      <section className="bg-foreground py-20 text-background md:py-28">
        <div className="mx-auto max-w-4xl px-6">
          <AnimateOnView>
            <span
              className="block h-px w-16 bg-primary"
              aria-hidden="true"
            />

            <p className="mt-8 text-[22px] leading-[1.6] text-background/90 md:text-[28px]">
              Este contato não é sobre vender. É sobre estar por perto de novo
              e deixar claro que{" "}
              <span className="text-primary">
                a porta continua aberta
              </span>{" "}
              para você, quando e se fizer sentido.
            </p>
          </AnimateOnView>
        </div>
      </section>
        ...
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
          <AnimateOnView>
            ...
            <p className="mt-3 text-lg text-muted-foreground">
              A Literare está vivendo uma fase nova. A casa mudou, novos
              projetos chegaram, novas histórias começaram mas algumas relações
              ...
              <br />
              <br />
              Não é uma proposta pronta, nem uma conversa com pressa. É só uma
              forma de dizer que, se você também sente vontade de escrever
              novamente, a nossa porta continua aberta.
              <br />
              <br />
              Talvez exista uma próxima história esperando para ser contada. E,
              quem sabe, ela possa nascer aqui outra vez.
            </p>
          </AnimateOnView>
          ...
          <div>
            <AnimateOnView>
              ...
              <p className="mt-5 max-w-xl text-lg leading-relaxed text-muted-foreground">
                Quando surgir um projeto de coautoria com a sua cara,
                adoraríamos ter você. Uma participação leve, do seu jeito.
              </p>
            </AnimateOnView>
            ...
            {comoFunciona.map((item, index) => (
              ...
              >
                <div className="border-t border-background/20 pt-6">
                  ...
                  <h3 className="mt-5 text-xl font-medium text-background">
                    {item.titulo}
                  </h3>
        ...
        <AnimateOnView>
          <div className="border border-foreground/12 bg-secondary/50 px-7 py-12 md:px-16 md:py-16">
            ...
            <p className="mt-8 text-[20px] leading-[1.7] md:text-[24px]">
              Escrever um livro com a gente nunca foi só um contrato. Foi uma
              convivência. Se der vontade de escrever de novo, um capítulo, uma
              ideia, uma conversa, é só responder. Vou gostar de saber de você.
            </p>
